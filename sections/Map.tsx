        ...
        <div className="mt-auto pointer-events-auto">
          <div className="glass p-4 rounded-3xl border-white/10 flex items-center gap-6 max-w-fit overflow-x-auto">
             ...
             <div className="flex -space-x-3">
               ...
               <div className="w-8 h-8 rounded-full bg-emerald-600 flex items-center justify-center text-[10px] font-bold border-2 border-slate-900">
               </div>  
           <p className="text-xs text-slate-400 italic">Planificando en tiempo real con amigos</p>
          <div class button= onclick Explorar Colombia en tiempo real> 
          </div>
          <button onclick="window.open('https://www.google.com/maps/place/Colombia', '_blank')"> Explorar Colombia en tiempo real </button> 
             </div>
      </div>
    </div>
  );
